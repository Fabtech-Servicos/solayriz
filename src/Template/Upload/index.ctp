              ...
              <?php foreach ($upload as $upload): ?>
                <tr>
                  ...
                  <td><?= h($upload->title) ?></td>
                    <td><?= h("/files/Upload/photo/").h($upload->photo) ?></td>
                  <td><?= h($upload->photo) ?></td>
                  <td><?= h($upload->photo_dir) ?></td>
                  <td class="actions text-right">
                      <?= $this->Html->link(__('View'), ['action' => 'view', $upload->id], ['class'=>'btn btn-info btn-xs']) ?>
                      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $upload->id], ['class'=>'btn btn-warning btn-xs']) ?>
