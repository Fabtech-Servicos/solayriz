                ...
                <div class="single-footer-widget marbtm50">
                    <div class="contact-info-box">
                        ...
                        <div class="text">
                            ...
                            <ul>
                                <li>solartech@example.com</li>
                                <li>Mon - Fri: 9am to 6pm, <span>W.e/ Holiday</span></li>
                            </ul>
                            <a class="btn-two" href="#">go to Map<span class="icon-null"></span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="copyright-text">
                    <p>© 2009–2019 All Rights Reserved by <a href="#">Solartech.</a> <br>Certified Solar Energy Company.</p>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
